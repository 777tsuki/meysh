...
#功能界面
$setpassword='<h1 style="text-align: center;color:rgb(80, 80, 80)">梅什号</h1>
<form target="_blank" class="table" action="user.php?function=setpassword" method="post">
  <h2>设置新密码</h2><hr/><br>
...
$verify='<h1 style="text-align: center;color:rgb(80, 80, 80)">梅什号</h1>
<form class="table" action="user.php?function=verify" method="post">
  <h2>验证</h2><hr/><br>
...
<a class="table" style="height:370px;text-decoration:none"><h1><br><br>报上你的名字<br>（不要太长太短太奇怪哦）</h1><br><form target="_blank" method="post" action="user.php?function=setusername"><input type="text" name="inputname" class="import"   style="width:213px;">
...
<form class="table" action="user.php?function=active" method="post">
  <h2>激活</h2><hr/><br>
...
<form class="table" action="user.php?function=login" method="post">
  <h2>登录</h2><hr/><br>
  <a>邮箱  </a><input type="text" name="mail" class="import"><br><br>
  <a>密码  </a><input type="password" name="password" class="import"><br><br>
...
<div class="others">
  <a class="other" href="../../user.php?link=forgetpassword" style="float:left"><h2>忘记密码</h2></a>
  <a class="other" href="../../user.php?link=register" style="float:right"><h2>注册</h2></a>
</div>';
$register='<h1 style="text-align: center;color:rgb(80, 80, 80)">梅什号</h1>
<form class="table" action="user.php?function=register" method="post">
  <h2>注册</h2><hr/><br>
...
<div class="others">
  <a class="other" href="../../user.php?link=forgetpassword" style="float:left"><h2>忘记密码</h2></a>
  <a class="other" href="../../user.php?link=login" style="float:right"><h2>登录</h2></a>
</div>';
$forgetpassword='<h1 style="text-align: center;color:rgb(80, 80, 80)">梅什号</h1>
<form class="table" action="user.php?function=forgetpassword" method="post">
  <h2>在邮件中重置密码</h2><hr/><br>
  <a>邮箱  </a><input type="text" name="mail" class="import"><br><br>
  <input type="submit" value="NEXT" class="clickbotton"><p></p>
</form><br>
<div class="others">
  <a class="other" href="../../user.php?link=login" style="float:left"><h2>登录</h2></a>
  <a class="other" href="../../user.php?link=register" style="float:right"><h2>注册</h2></a>
</div>';
#提示
...
$sendsuccess1=$notice.'<br><a href="index.php" class="table" style="height:370px;text-decoration:none"><h1><br><br>操作链接已发送至邮箱<br>神秘数字：';
$sendsuccess2='<br><br>'.$right.'<br></h1></a>';
$outdated=$notice.'<a class="table" style="height:370px;text-decoration:none" href="index.php"><h1><br><br>操作链接已过期<br><br>'.$wrong.'<br></h1></a>';
...
$registersuccess=$notice.'<br><a href="user.php" class="table" style="height:370px;text-decoration:none"><h1><br><br>临时账号注册成功<br>可以到邮箱中激活<br><br>'.$right.'<br></h1></a>';
...
$loginsuccess=$notice.'<br><a href="user.php" class="table" style="height:370px;text-decoration:none"><h1><br><br>登录成功<br><br>'.$right.'<br></h1></a>';
